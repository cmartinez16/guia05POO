 ...
 * @author Clarissa
 */
public class Ferreteria extends Empresa1{
   protected String NumeroIVA;
   protected String Horarios;
   
   public Ferreteria(){}

    public Ferreteria(String NombreEmpresa, int CantidadEmpleados, int CantidadAños,String NumeroIVA, String Horarios) {
